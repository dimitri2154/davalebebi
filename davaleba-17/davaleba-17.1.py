...
# თუ ინდექსი 0-ზე ნაკლებია ან სია ცარიელია, არაფერს არ გააკეთებს.
# თუ ინდექსი არის 0, განაახლებს თავს შემდეგ კვანძს.
# წინააღმდეგ შემთხვევაში კი გაყვება სიას, რომ იპოვოს კვანძი, რომელიც უნდა წაიშალოს და განაახლებს შემდეგ.
